...
const StrongBrand = () => {
  ...
  return (
    <div className="md:h-screen overflow-hidden max-md:py-8 relative flex gap-12 font-a text-white justify-center items-center bg-primaryBlack md:mt-[50vh] max-md:mt-[40dvh] max-md:h-[100dvh]">
      <div1
        id="brand-text"
